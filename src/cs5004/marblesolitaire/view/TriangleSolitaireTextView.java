...
/**
 * a textview for the triangle board.
 */
public class TriangleSolitaireTextView implements MarbleSolitaireView {
   ...
   */
  public TriangleSolitaireTextView(MarbleSolitaireModelState x) {
    this(x, System.out);
  }
   ...
   */
  public TriangleSolitaireTextView(MarbleSolitaireModelState x, Appendable ap) {
    if (x == null || ap == null) {
